...
const Footer = (props) => {
    ...
    return (
        <div>
            <footer className="px-4 divide-y text-gray-100 bg-gray-900">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                            <div className="flex items-center justify-center w-36 h-36 rounded-full dark:bg-violet-400">
                                <img src="https://cyberlearn.vn/wp-content/uploads/2020/03/cyberlearn-min-new-opt2.png" alt='logo' className='' width={'500px'} />
                            </div>

                        </a>
                    </div>
                    <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4 text-gray-100">
                        ...
                        <div className="space-y-3 ">
                            ...
                            <ul className="space-y-1 ">
                                <li>
                                    <a rel="noopener noreferrer" href="#" className='text-gray-300'>Privacy</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="#" className='text-gray-300'>Terms of Service</a>
                                </li>
                            </ul>
                        </div>
                        <div className="space-y-3">
                            ...
                            <ul className="space-y-1">
                                <li>
                                    <a rel="noopener noreferrer" href="#" className='text-gray-300'>Public API</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="#" className='text-gray-300'>Documentation</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="#" className='text-gray-300'>Guides</a>
                                </li>
                            </ul>
                        </div>
                        <div className="space-y-3">
