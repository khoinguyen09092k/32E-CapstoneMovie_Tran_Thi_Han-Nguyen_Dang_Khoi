...
const Login = () => {
  ...
  return (
    <form onSubmit={formik.handleSubmit} className="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
      <div className="w-full">
        ...
        <div>
          ...
          <input name='taiKhoan' onChange={formik.handleChange}  className="w-full px-4 py-2 text-sm border rounded-md focus:border-blue-400 focus:outline-none focus:ring-1 focus:ring-blue-600" placeholder />
        </div>
        <div>
          <label className="block mt-4 text-sm">
           Mật Khẩu
          </label>
          <input name='matKhau' onChange={formik.handleChange} className="w-full px-4 py-2 text-sm border rounded-md focus:border-blue-400 focus:outline-none focus:ring-1 focus:ring-blue-600" placeholder type="password" />
        </div>
