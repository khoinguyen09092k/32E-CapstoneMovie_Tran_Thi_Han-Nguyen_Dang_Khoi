    ...
    <div className="min-h-screen bg-black text-white" >
      <div className="grid grid-cols-12">
          ...
          <div className='mt-5'>
            <table className="border-collapse border border-slate-500">
              <thead className='px-5'>
                <tr>
                  <th className="border p-5">Loại Ghế</th>
                  ...
                  <th>
                    <td className="border p-4 ">
                      <button className='bg-green-500 gheChuThich'><UserAddOutlined  style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }} /></button>
                    </td>
                  </th>
                </tr>
              </thead>
        ...
        <div className="col-span-3 mt-2">
          ...
          <p className='text-red-400 text-lg'>Địa Điểm:  <span className='text-blue-400 text-lg'>{thongTinPhim.tenCumRap} - {thongTinPhim.tenRap}</span> </p>
          <p className='text-red-400 text-lg'>Ngày Chiếu: <span className='text-blue-400 text-lg'>{thongTinPhim.ngayChieu} - {thongTinPhim.gioChieu}</span> </p>
          <hr />
          <div className="flex flex-col my-5">
            <div className=''>
              <span className='text-red-400 text-lg'>Mã Số Ghế:</span>
              {_.sortBy(danhSachGheDangDat, ['maGhe', 'stt']).map((gheDD, index) => {
                return <span className='text-blue-500 text-lg' key={index}> [{gheDD.stt}]</span>
              })}
            </div>
          </div>
          <hr />
          ...
          <div className="flex flex-col-reverse justify-center items-center">
            <button className='mt-5 block w-full text-2xl bg-blue-500 px-3 text-center text-white py-3 font-bold'
              onClick={() => {
